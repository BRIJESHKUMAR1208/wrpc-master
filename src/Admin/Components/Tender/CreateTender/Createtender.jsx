...
export const CreateTender = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.tender_tittle) {
      errors.tender_tittle = 'Please enter your Tender Name';
    } else if (!/^[A-Za-z ]+$/.test(formData.tender_tittle) && parseInt(formData.languagetype) == 1) {
      errors.tender_tittle = 'Please input alphabet characters only';
    } else if (!/^[\u0900-\u097F\s]+$/.test(formData.tender_tittle) && parseInt(formData.languagetype) == 2) {
